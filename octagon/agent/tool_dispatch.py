...
class ToolDispatch:
    ...
    def dispatch_function(self, response_message, message_list) -> tuple[bool, bool]:
        ...
        for tool_call in response_message.tool_calls:
            if tool_call.function.name in self.dispatch_dictionary:
                ...
                if len(parameters) < len(sig.parameters) - optional_parameters or len(
                    parameters
                ) > len(sig.parameters):
                ...
                if tool_call.function.name == "stop":
                    has_stop = True
