...
class TestPortfolio(unittest.TestCase):
    ...
    def test_formatted_historical_data(self):
        print(formatted_historical_data(self.ticker, '2026-01-01', '2026-07-01', '1mo'))
    ...
    def test_get_options_chain(self):
        print(get_options_chain(self.ticker, '2026-07-20'))
    ...
    def test_particle_filter(self):
        print(particle_filter_forecast(self.ticker, '1m'))
