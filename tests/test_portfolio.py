...
class TestPortfolio(unittest.TestCase):
    ...
    def test_buy_item_sufficient_balance(self, mock_price):
        ...
        expected_msg = (
            "Bought 2 units of AAPL at $100.00. Your new uninvested balance is $900.00."
        )
    ...
    def test_buy_item_existing_ticker(self, mock_price):
        ...
        # Check return message
        expected_msg = (
            "Bought 1 units of AAPL at $60.00. Your new uninvested balance is $840.00."
        )
        self.assertEqual(result, expected_msg)
    ...
    def test_sell_item_insufficient_quantity(self, mock_price):
        ...
        self.assertEqual(
            result,
            "Selling all 2.00 of AAPL, since the request amount of 2 is greater than "
    ...
    def test_sell_item_success(self, mock_price):
        ...
        # Check return message
        expected_msg = (
            "Sold 1 units of AAPL at $60.00. You new uninvested balance is $960.00."
        )
        self.assertEqual(result, expected_msg)
    ...
    def test_get_formatted_portfolio(self, mock_price):
        ...
        with patch("octagon.tools.assets.portfolio.available_assets") as mock_assets:
            ...
            self.portfolio.portfolio_map = {
                "AAPL": Possession(
                    quantity=100.0, purchase_value=520, purchase_history=[]
                ),
                "MSFT": Possession(
                    quantity=50.0, purchase_value=48, purchase_history=[]
                ),
            }
    ...
    def test_save_and_load_portfolio(self):
        my_map = {
            ...
            "MSFT": Possession(
                ...
                purchase_value=48,
                purchase_history=[
                    Purchase(price=90.4, amount=89.4),
                    Purchase(price=383.234, amount=213.45),
                ],
            ),
        }
